...
const ClothingDetails = () => {
  ...
  const clothe = clothing.find((item) => item.id === Number(id));

  console.log(clothe?.title);
    ...
    <div className="h-screen w-full">
      ...
      <div className="flex flex-wrap rounded-2xl mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 gap-4 py-10">
        ...
        <div className="flex-1 flex flex-col gap-4 p-6 min-w-80">
          <h1 className="text-2xl md:text-4xl font-semibold">{clothe.title}</h1>
          <p className="text-sm md:text-lg">{clothe.price}</p>
          ...
          <span className="flex gap-4 items-center justify-center">
            ...
            <LiaHeartSolid className="text-4xl" />
          </span>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-4">
              <div className="flex gap-4 items-center justify-center p-2 ">
                ...
                <span>
                  <p className="text-xs text-black/30">Delivery Time</p>
              ...
              <div className="flex gap-4 items-center justify-center p-2">
                ...
                <span>
                  <p className="text-xs text-black/30">Estimate Arrival</p>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-4">
              <div className="flex gap-4 items-center justify-center p-2 ">
                ...
                <span>
                  <p className="text-xs text-black/30">No discount Available</p>
                </span>
              </div>
            </div>
          </div>
