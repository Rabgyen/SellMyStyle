              ...
              <div className="rounded-2xl border border-slate-100 bg-white p-5">
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {styleTags.map((tag) => (
                    <span
                      key={tag}
                      className="rounded-full bg-slate-50 px-3.5 py-1.5 text-xs font-medium text-slate-700 transition hover:bg-indigo-50 hover:text-indigo-500"
                    >
                      {tag}
                    </span>
                  ))}
                        ...
                        return (
                          <article key={product.product_id} className="group relative overflow-hidden rounded-2xl border border-slate-100 bg-white transition hover:shadow-md">
                            <button
                              ...
                              className="absolute right-3 top-3 z-10 inline-flex items-center gap-1 rounded-full bg-white/95 px-2.5 py-1 text-[11px] font-semibold text-slate-700 shadow-sm ring-1 ring-slate-100 transition hover:bg-slate-50"
                            >
